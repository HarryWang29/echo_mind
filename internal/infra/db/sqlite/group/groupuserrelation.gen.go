...
func newGroupUserRelation(db *gorm.DB, opts ...gen.DOOption) groupUserRelation {
	...
	_groupUserRelation.UserName = field.NewString(tableName, "userName")
	_groupUserRelation.GroupNameList = field.NewString(tableName, "groupNameList")
...
func (g *groupUserRelation) updateTableName(table string) *groupUserRelation {
	...
	g.GroupNameList = field.NewString(table, "groupNameList")
...
func (g *groupUserRelation) fillFieldMap() {
	...
	g.fieldMap["groupNameList"] = g.GroupNameList
}
...
func (g groupUserRelationDo) GetByID(id int) (result model.GroupUserRelation, err error) {
	...
	generateSQL.WriteString("SELECT * FROM GroupUserRelation WHERE id=? ")
